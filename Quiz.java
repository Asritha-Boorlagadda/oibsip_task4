...
public class Quiz implements ActionListener {
    ...
    public void set() {
        ...
        if (question == 0) {
            l16.setText("1) What is the wrong syntax for main method of a java class ?");
            r[0].setText("static public void main(String[] args)");
            r[1].setText("public static void main(String[] a)");
            r[2].setText("public static void main(String[] args)");
        ...
        if (question == 2) {
            l16.setText("3) Which of the following is NOT a principle of OOP ?");
            r[0].setText("Inheritance");
            r[1].setText("Encapsulation");
            r[2].setText("Polymorphism");
            r[3].setText("Parallelism");
        }
        if (question == 3) {
            l16.setText("4) All standard classes of java are included within a package called ___ ");
            r[0].setText("java.io");
        ...
        if (question == 5) {
            l16.setText("6) The methods of an interface are by default ___");
        ...
        if (question == 7) {
            l16.setText("8) What is the keyword used to inherit the properties of a class ?");
            r[0].setText("super");
            r[1].setText("extends");
            r[2].setText("abstract");
            r[3].setText("final");
        }
        if (question == 8) {
